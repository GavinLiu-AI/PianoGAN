...
def organize_temp_fake_images(src_dir, dest_dir):
    """
    Move generated images into individual folders with time stamps, for tidiness

    :param src_dir: directory that stores generated fake images
    :param dest_dir: destination directory where images will be stored with time stamps
    """
